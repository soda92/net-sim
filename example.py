...
# 定义五个信息片段的S_List=[[[1,2,3,...,n],[],[],,,,,,,,,,,,,[]],
# 信息片段1，n次迭代每一次迭代的S状态的节点集合
# [[1,2,3,...,n],[],[],,,,,,,,,,,,,[]],
# 信息片段2，n次迭代后的S状态的节点集合，，，，
# [[1,2,3,...,n],[],[],,,,,,,,,,,,,[]],
# 信息片段5，n次迭代后的S状态的节点集合]
# 这个地方明天再看看
parser.add_argument("--S_List", type=list, default=[])
# 定义五个信息片段的I_List=[[[],[1],[1,8,9],[1,8,9,20],,,,,,[1,2,3,4,5,....,n]],
# 信息片段1，n次迭代每一次迭代的I状态的节点集合  [],[],[],[]]
